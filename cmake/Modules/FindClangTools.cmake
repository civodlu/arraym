#
# Source: https://github.com/apache/arrow/blob/master/cpp/cmake_modules/FindClangTools.cmake
#
...
find_program(CLANG_TIDY_BIN 
  NAMES clang-tidy-4.0 clang-tidy-3.9 clang-tidy-3.8 clang-tidy-3.7 clang-tidy-3.6  clang-tidy
  PATHS ${ClangTools_PATH} $ENV{CLANG_TOOLS_PATH} /usr/local/bin /usr/bin "C:/Program Files/LLVM/bin"
        NO_DEFAULT_PATH
)
...
find_program(CLANG_FORMAT_BIN 
  NAMES clang-format-4.0 clang-format-3.9 clang-format-3.8 clang-format-3.7 clang-format-3.6  clang-format clang-format.exe
  PATHS ${ClangTools_PATH} $ENV{CLANG_TOOLS_PATH} /usr/local/bin /usr/bin "C:/Program Files/LLVM/bin"
        NO_DEFAULT_PATH
)
