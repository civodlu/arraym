...
class is_matrix<Array<T, 2, ArrayTraitsConfig<T, 2, Allocator, Memory_contiguous<T, 2, IndexMapper_contiguous_matrix_column_major>>>> : std::true_type
{
};

template <class T, class Allocator>
class is_matrix<Array<T, 2, ArrayTraitsConfig<T, 2, Allocator, Memory_contiguous<T, 2, IndexMapper_contiguous_matrix_row_major>>>> : std::true_type
{
};
