...
BlasInt gemm(CBLAS_ORDER matrixOrder, const enum CBLAS_TRANSPOSE TransA, const enum CBLAS_TRANSPOSE TransB, const BlasInt M, const BlasInt N, const BlasInt K,
             const T alpha, const cuda_ptr<T> A, const BlasInt lda, const cuda_ptr<T> B, const BlasInt ldb, const T beta, cuda_ptr<T> C, const BlasInt ldc);
...
template <class T>
BlasInt ger(CBLAS_ORDER matrixOrder, const BlasInt M, const BlasInt N, const T alpha, const cuda_ptr<T> x, const BlasInt incX, const cuda_ptr<T> y,
            const BlasInt incY, cuda_ptr<T> A, const BlasInt lda);

template <class T>
BlasInt gemv(CBLAS_ORDER matrixOrder, const enum CBLAS_TRANSPOSE TransA, const BlasInt M, const BlasInt N, const T alpha, const cuda_ptr<T> A,
             const BlasInt lda, const cuda_ptr<T> x, const BlasInt incX, const T beta, cuda_ptr<T> y, const BlasInt incY);
