...
template <>
ARRAY_API BlasInt axpy<BlasDoubleReal>(BlasInt N, BlasDoubleReal alpha, const cuda_ptr<BlasDoubleReal> x, BlasInt incx, cuda_ptr<BlasDoubleReal> y,
                                       BlasInt incy)
{
...
template <>
ARRAY_API BlasInt gemm<BlasReal>(CBLAS_ORDER matrixOrder, const enum CBLAS_TRANSPOSE TransA, const enum CBLAS_TRANSPOSE TransB, const BlasInt M,
                                 const BlasInt N, const BlasInt K, const BlasReal alpha, const cuda_ptr<BlasReal> A, const BlasInt lda,
                                 const cuda_ptr<BlasReal> B, const BlasInt ldb, const BlasReal beta, cuda_ptr<BlasReal> C, const BlasInt ldc)
{
...
template <>
ARRAY_API BlasInt gemm<BlasDoubleReal>(CBLAS_ORDER matrixOrder, const enum CBLAS_TRANSPOSE TransA, const enum CBLAS_TRANSPOSE TransB, const BlasInt M,
                                       const BlasInt N, const BlasInt K, const BlasDoubleReal alpha, const cuda_ptr<BlasDoubleReal> A, const BlasInt lda,
                                       const cuda_ptr<BlasDoubleReal> B, const BlasInt ldb, const BlasDoubleReal beta, cuda_ptr<BlasDoubleReal> C,
                                       const BlasInt ldc)
{
   ensure(matrixOrder == CBLAS_ORDER::CblasColMajor, "CUBLAS handle only column major");
...
template <>
ARRAY_API BlasDoubleReal dot<BlasDoubleReal>(const BlasInt N, const cuda_ptr<BlasDoubleReal> x, const BlasInt incX, const cuda_ptr<BlasDoubleReal> y,
                                             const BlasInt incY)
{
   BlasDoubleReal result = 0;
...
template <>
ARRAY_API BlasInt ger<BlasReal>(CBLAS_ORDER matrixOrder, const BlasInt M, const BlasInt N, const BlasReal alpha, const cuda_ptr<BlasReal> x, const BlasInt incX,
                                const cuda_ptr<BlasReal> y, const BlasInt incY, cuda_ptr<BlasReal> A, const BlasInt lda)
{
   ensure(matrixOrder == CBLAS_ORDER::CblasColMajor, "CUBLAS handle only column major");
...
template <>
ARRAY_API BlasInt ger<BlasDoubleReal>(CBLAS_ORDER matrixOrder, const BlasInt M, const BlasInt N, const BlasDoubleReal alpha, const cuda_ptr<BlasDoubleReal> x,
                                      const BlasInt incX, const cuda_ptr<BlasDoubleReal> y, const BlasInt incY, cuda_ptr<BlasDoubleReal> A, const BlasInt lda)
{
   ensure(matrixOrder == CBLAS_ORDER::CblasColMajor, "CUBLAS handle only column major");
...
template <>
ARRAY_API BlasInt gemv<BlasReal>(CBLAS_ORDER matrixOrder, const enum CBLAS_TRANSPOSE TransA, const BlasInt M, const BlasInt N, const BlasReal alpha,
                                 const cuda_ptr<BlasReal> A, const BlasInt lda, const cuda_ptr<BlasReal> x, const BlasInt incX, const BlasReal beta,
...
template <>
ARRAY_API BlasInt gemv<BlasDoubleReal>(CBLAS_ORDER matrixOrder, const enum CBLAS_TRANSPOSE TransA, const BlasInt M, const BlasInt N, const BlasDoubleReal alpha,
                                       const cuda_ptr<BlasDoubleReal> A, const BlasInt lda, const cuda_ptr<BlasDoubleReal> x, const BlasInt incX,
                                       const BlasDoubleReal beta, cuda_ptr<BlasDoubleReal> y, const BlasInt incY)
{
   ensure(matrixOrder == CBLAS_ORDER::CblasColMajor, "CUBLAS handle only column major");
