...
namespace blas
{
   ...
   template <class T>
   void gemm( CBLAS_ORDER matrixOrder,
              const enum CBLAS_TRANSPOSE TransA, const enum CBLAS_TRANSPOSE TransB,
              const BlasInt M, const BlasInt N, const BlasInt K, const T alpha, const T *A,
              const BlasInt lda, const T *B, const BlasInt ldb, const T beta, T *C,
              const BlasInt ldc )
   {
      ensure( 0, "BlasInterface not implemented for this type!" );
   }
   ...
   template <>
   inline void gemm<BlasReal>( CBLAS_ORDER matrixOrder,
                               const enum CBLAS_TRANSPOSE TransA, const enum CBLAS_TRANSPOSE TransB,
                               const BlasInt M, const BlasInt N, const BlasInt K, const BlasReal alpha, const BlasReal *A,
                               const BlasInt lda, const BlasReal *B, const BlasInt ldb, const BlasReal beta, BlasReal *C,
                               const BlasInt ldc )
   {
   ...
   template <>
   inline void gemm<BlasDoubleReal>( CBLAS_ORDER matrixOrder,
                                     const enum CBLAS_TRANSPOSE TransA, const enum CBLAS_TRANSPOSE TransB,
                                     const BlasInt M, const BlasInt N, const BlasInt K, const BlasDoubleReal alpha, const BlasDoubleReal *A,
                                     const BlasInt lda, const BlasDoubleReal *B, const BlasInt ldb, const BlasDoubleReal beta, BlasDoubleReal *C,
                                     const BlasInt ldc )
   {
   ...
   template <class T>
   void ger( CBLAS_ORDER matrixOrder,
             const BlasInt M, const BlasInt N, const T alpha, const T *x, const BlasInt incX,
             const T *y, const BlasInt incY, T *A, const BlasInt lda )
   {
      ensure( 0, "BlasInterface not implemented for this type!" );
   }

   template <>
   inline void ger<BlasReal>( CBLAS_ORDER matrixOrder,
                              const BlasInt M, const BlasInt N, const BlasReal alpha, const BlasReal *x, const BlasInt incX,
   ...
   template <>
   inline void ger<BlasDoubleReal>( CBLAS_ORDER matrixOrder,
                                    const BlasInt M, const BlasInt N, const BlasDoubleReal alpha, const BlasDoubleReal *x, const BlasInt incX,
   ...
   template <class T>
   void gemv( CBLAS_ORDER matrixOrder,
              const enum CBLAS_TRANSPOSE TransA, const BlasInt M, const BlasInt N,
              const T alpha, const T *A, const BlasInt lda, const T *x, const BlasInt incX,
              const T beta, T *y, const BlasInt incY )
   {
      ensure( 0, "BlasInterface not implemented for this type!" );
   }

   template <>
   inline void gemv<BlasReal>( CBLAS_ORDER matrixOrder,
                               const enum CBLAS_TRANSPOSE TransA, const BlasInt M, const BlasInt N,
                               const BlasReal alpha, const BlasReal *A, const BlasInt lda, const BlasReal *x, const BlasInt incX,
                               const BlasReal beta, BlasReal *y, const BlasInt incY )
   ...
   template <>
   inline void gemv<BlasDoubleReal>( CBLAS_ORDER matrixOrder,
                                     const enum CBLAS_TRANSPOSE TransA, const BlasInt M, const BlasInt N,
                                     const BlasDoubleReal alpha, const BlasDoubleReal *A, const BlasInt lda, const BlasDoubleReal *x, const BlasInt incX,
                                     const BlasDoubleReal beta, BlasDoubleReal *y, const BlasInt incY )
   {
   ...
   template <class T>
   int gesdd( CBLAS_ORDER matrixOrder, char jobz, BlasInt m,
              BlasInt n, T* a, BlasInt lda, T* s,
              T* u, BlasInt ldu, T* vt,
              BlasInt ldvt )
   {
      ensure( 0, "BlasInterface not implemented for this type!" );
   }
   ...
   template <>
   inline int gesdd<BlasReal>( CBLAS_ORDER matrixOrder, char jobz, BlasInt m,
                               BlasInt n, BlasReal* a, BlasInt lda, BlasReal* s,
                               BlasReal* u, BlasInt ldu, BlasReal* vt,
                               BlasInt ldvt )
   {
#ifdef INSTRUMENT_BLAS_CALLS
      INSTRUMENT_BLAS( "gesdd<BlasReal>" );
#endif
      return BlasDispatcher::instance().call<details::BlasFunction::sgesdd>( matrixOrder, jobz, m,
                                                                            n, a, lda, s,
                                                                            u, ldu, vt,
                                                                            ldvt );
   }
   ...
   template <>
   inline int gesdd<BlasDoubleReal>( CBLAS_ORDER matrixOrder, char jobz, BlasInt m,
                                     BlasInt n, BlasDoubleReal* a, BlasInt lda, BlasDoubleReal* s,
                                     BlasDoubleReal* u, BlasInt ldu, BlasDoubleReal* vt,
                                     BlasInt ldvt )
   {
#ifdef INSTRUMENT_BLAS_CALLS
      INSTRUMENT_BLAS( "gesdd<BlasDoubleReal>" );
#endif
      return BlasDispatcher::instance().call<details::BlasFunction::dgesdd>( matrixOrder, jobz, m,
                                                                            n, a, lda, s,
                                                                            u, ldu, vt,
                                                                            ldvt );
   }
   ...
   template <class T>
   int laswp( CBLAS_ORDER matrixOrder, BlasInt n, T* a,
              BlasInt lda, BlasInt k1, BlasInt k2,
              const BlasInt* ipiv, BlasInt incx )
   {
      ensure( 0, "BlasInterface not implemented for this type!" );
   }

   template <>
   inline int laswp<BlasReal>( CBLAS_ORDER matrixOrder, BlasInt n, BlasReal* a,
                               BlasInt lda, BlasInt k1, BlasInt k2,
                               const BlasInt* ipiv, BlasInt incx )
   {
#ifdef INSTRUMENT_BLAS_CALLS
   ...
   template <>
   inline int laswp<BlasDoubleReal>( CBLAS_ORDER matrixOrder, BlasInt n, BlasDoubleReal* a,
                                     BlasInt lda, BlasInt k1, BlasInt k2,
                                     const BlasInt* ipiv, BlasInt incx )
   {
#ifdef INSTRUMENT_BLAS_CALLS
   ...
   template <class T>
   int getrs( CBLAS_ORDER matrix_order, char trans, BlasInt n,
              BlasInt nrhs, const T* a, BlasInt lda,
              const BlasInt* ipiv, T* b, BlasInt ldb )
   {
      ensure( 0, "BlasInterface not implemented for this type!" );
   }

   template <>
   inline int getrs<BlasReal>( CBLAS_ORDER matrix_order, char trans, BlasInt n,
                               BlasInt nrhs, const BlasReal* a, BlasInt lda,
                               const BlasInt* ipiv, BlasReal* b, BlasInt ldb )
   {
      return BlasDispatcher::instance().call<details::BlasFunction::sgetrs>( matrix_order, trans, n, nrhs, a, lda, ipiv, b, ldb );
   }

   template <>
   inline int getrs<BlasDoubleReal>( CBLAS_ORDER matrix_order, char trans, BlasInt n,
                                     BlasInt nrhs, const BlasDoubleReal* a, BlasInt lda,
                                     const BlasInt* ipiv, BlasDoubleReal* b, BlasInt ldb )
   {
   ...
   template <class T>
   int gels( CBLAS_ORDER matrix_layout, char trans, BlasInt m, BlasInt n,
             BlasInt nrhs, T* a, BlasInt lda, T* b, BlasInt ldb )
   {
      ensure( 0, "BlasInterface not implemented for this type!" );
   }

   template <>
   inline int gels<BlasReal>( CBLAS_ORDER matrix_layout, char trans, BlasInt m, BlasInt n,
                              BlasInt nrhs, BlasReal* a, BlasInt lda, BlasReal* b, BlasInt ldb )
   {
      return BlasDispatcher::instance().call<details::BlasFunction::sgels>( matrix_layout, trans, m, n, nrhs, a, lda, b, ldb );
   }

   template <>
   inline int gels<BlasDoubleReal>( CBLAS_ORDER matrix_layout, char trans, BlasInt m, BlasInt n,
                                    BlasInt nrhs, BlasDoubleReal* a, BlasInt lda, BlasDoubleReal* b, BlasInt ldb )
   {
